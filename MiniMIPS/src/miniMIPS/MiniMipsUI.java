...
public class MiniMipsUI extends JFrame {
	 ...
	 */
	 ...
	 private void initGUI() {
		 ...
		 scpCode.setBounds(16, 21, 344, 115);
		 ...
		 btnLoadMipsCode.setBounds(372, 63, 80, 38);
		 ...
		 cbInstruction.addActionListener(new ActionListener() {
			 public void actionPerformed(ActionEvent e) {
				 if(cbInstruction.getSelectedItem().toString().equalsIgnoreCase("DADDIU")) {
		 ...
		 btnAdd.setBounds(372, 143, 82, 54);
		 ...
		 txtImmediate.setBounds(197, 141, 171, 26);
